...
def get_argument():
    ...
    parser.add_argument(
        "--files",
        type=str,
        help="The list of file path, Except value: /tmp/test1.csv,/tmp/test2.csv,/tmp/test3.csv",
        required=True,
    )

    parser.add_argument("--suffix", default=".csv", type=str, help="The suffix of label file")
