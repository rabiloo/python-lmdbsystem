...
def get_argument():
    ...
    parser.add_argument("--key-index", type=int, help="The index to extract key from the label line")
    ...
    parser.add_argument("--pattern-value-in-key", type=str, help="The pattern of value in key")

    parser.add_argument(
        "--type-value-in-key", type=str, choices=["int", "str", "float"], help="The type of value in key"
    )
