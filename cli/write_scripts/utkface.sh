...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/utkface_gender_origin.lmdb" \
    --folder "/tmp/facedata/original/UTKFace" \
    --suffix .jpg \
    --delimiter "_" \
    --values-index 1 \
    ...
    --fn-md5-path "/tmp/facedata/lmdb/utkface_fn_md5.json" \
    --from-filename
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/utkface_age_origin.lmdb" \
    --folder "/tmp/facedata/original/UTKFace" \
    --suffix .jpg \
    --delimiter "_" \
    --values-index 0 \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/utkface_gender_visage.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/utkface_age_visage.lmdb" \
    --folder "/tmp/facedata/labels/UTKFace/label_visage" \
    --suffix .txt \
    --delimiter "\n" \
    --values-index 1 \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/utkface_age_mivolo.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/utkface_age_mwr.lmdb" \
