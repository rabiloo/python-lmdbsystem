...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/afad_gender_origin.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/afad_age_origin.lmdb" \
    --files "/tmp/facedata/original/AFAD/AFAD-Full.txt" \
    --delimiter " " \
    --key-index 0 \
    --fn-md5-mode r \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/afad_gender_visage.lmdb" \
    ...
    --fn-md5-path "/tmp/facedata/lmdb/afad_fn_md5.json" \
    --values-map "Female:0,Male:1,female:0,male:1,111:1,112:0"
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/afad_age_visage.lmdb" \
    --folder "/tmp/facedata/labels/AFAD/label_visage" \
    --suffix .txt \
    --delimiter "\n" \
    --values-index 1 \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/afad_age_mivolo.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/afad_age_mwr.lmdb" \
