...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/rfw_age_origin.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/rfw_gender_visage.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/rfw_age_visage.lmdb" \
    --folder "/tmp/facedata/labels/RFW/label_visage" \
    --suffix .txt \
    --delimiter "\n" \
    --values-index 1 \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/rfw_age_mivolo.lmdb" \
...
python cli/write_txt.py --lmdb-file "/tmp/facedata/lmdb/rfw_age_mwr.lmdb" \
