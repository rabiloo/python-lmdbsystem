...
python cli/write_text.py --lmdb-file "/tmp/facedata/lmdb/aaf_gender_origin.lmdb" \
    ...
    --fn-md5-mode r \
    --fn-md5-path "/tmp/facedata/lmdb/aaf_fn_md5.json"
python cli/write_text.py --lmdb-file "/tmp/facedata/lmdb/aaf_age_origin.lmdb" \
    --files "/tmp/facedata/original/All-Age-Faces Dataset/image sets/train.txt,/tmp/facedata/original/All-Age-Faces Dataset/image sets/val.txt" \
    --delimiter " " \
    --key-index 0 \
    --fn-md5-mode r \
...
python cli/write_text.py --lmdb-file "/tmp/facedata/lmdb/aaf_age_mivolo.lmdb" \
...
python cli/write_text.py --lmdb-file "/tmp/facedata/lmdb/aaf_age_mwr.lmdb" \
